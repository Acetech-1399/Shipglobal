"""
Django settings for shipglobal_backend project.
...
SECRET_KEY = 'django-insecure-#+b0wl01e9w*%5bc&d64l%%z7!(s0!8d_)p6r)tl(=o*7z&sns'
...
WSGI_APPLICATION = 'shipglobal_backend.wsgi.application'
